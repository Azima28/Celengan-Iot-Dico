...
// ============ MODE SELECTION ============
// SET TO true for direct WiFi connection (Hardware WiFi must be working)
// SET TO false for Serial Bridge (USB to laptop with bridge.py running)
#define USE_WIFI_MODE false 

// ============ SUPABASE CONFIG ============
#define SUPABASE_URL "https://bivdzhwizmgyvobypzys.supabase.co"
#define SUPABASE_KEY "sb_publishable_Q6I1cfAm6AVi6X221_kNVA_xpXvNph4"
